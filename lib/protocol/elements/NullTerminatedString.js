...
NullTerminatedString.prototype.write = function(buffer, start, end) {
  ...
  return this._writer.write(buffer, nullIndex !== undefined);
};
...
StringWriter.prototype.write = function(buffer, last) {
...
BufferWriter.prototype.write = function(buffer, last) {
  var target = this._target;
