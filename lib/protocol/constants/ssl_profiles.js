...
exports['Amazon RDS'] = {
  ca: [
    ...
    /**
     * Amazon RDS ap-east-1 Root CA 2019 to 2024
     *
     *   CN = Amazon RDS ap-east-1 Root CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-02-17T19:20:36Z/2024-10-28T19:20:36Z
     *   F = BC:97:5C:11:9D:EB:0E:16:08:9F:33:11:22:B9:64:2C:8B:E7:7B:D9
     */
    '-----BEGIN CERTIFICATE-----\n'
     ...
     *
     *   CN = Amazon RDS me-south-1 CA 2019 to 2025
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-05-10T21:58:43Z/2025-06-01T12:00:00Z
     *   F = BA:C8:A2:98:D9:0C:C3:54:4C:46:42:5A:7A:1D:F6:9E:FA:EC:9D:2A
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS Beta us-east-1 CA 2019 to 2024
     *
     *   CN = Amazon RDS Beta Root 2019 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-08-20T17:10:07Z/2024-08-19T17:38:26Z
     *   F = D1:69:4C:02:0D:08:64:28:B3:2E:DE:B6:E4:34:9F:C4:C7:D9:32:EF
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS Beta Root CA 2019 to 2024
     *
     *   CN = Amazon RDS Beta Root 2019 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     ...
     *   ST = Washington
     *   C = US
     *   P = 2019-08-19T17:38:26Z/2024-08-19T17:38:26Z
     *   F = 86:4B:35:F4:8F:06:98:3A:A1:09:3E:BF:1E:DA:12:06:A1:C1:BC:FA
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS Preview us-east-2 CA 2019 to 2024
     *
     *   CN = Amazon RDS Preview us-east-2 2019 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-08-21T22:39:47Z/2024-08-21T22:29:49Z
     *   F = 80:DE:D8:10:44:38:B9:1C:D0:C7:00:7D:9A:41:37:D0:0B:18:F4:3B
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS Preview Root CA 2019 to 2024
     *
     *   CN = Amazon RDS Preview Root 2019 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-08-21T22:29:49Z/2024-08-21T22:29:49Z
     *   F = 6C:60:2F:1F:D6:AA:69:6E:F5:E2:4B:4E:09:0C:2F:54:42:5D:77:CA
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS af-south-1 CA 2019 to 2024
     *
     *   CN = Amazon RDS af-south-1 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-10-28T17:06:53Z/2024-10-28T17:06:53Z
     *   F = B4:4A:07:32:FD:BB:D7:79:44:6A:D2:4B:80:5D:3E:1D:E9:11:A9:5D
     */
    '-----BEGIN CERTIFICATE-----\n'
    + 'MIIECTCCAvGgAwIBAgICEAAwDQYJKoZIhvcNAQELBQAwgZUxCzAJBgNVBAYTAlVT\n'
    + 'MRAwDgYDVQQHDAdTZWF0dGxlMRMwEQYDVQQIDApXYXNoaW5ndG9uMSIwIAYDVQQK\n'
    ...
    /**
     * Amazon RDS eu-south-1 Root CA 2019 to 2024
     *
     *   CN = Amazon RDS eu-south-1 Root CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-10-30T19:20:36Z/2024-10-28T19:20:36Z
     *   F = 7B:42:BA:A6:6E:0D:7C:90:AA:C0:C9:7D:2F:55:08:A4:12:86:CD:E0
     */
    '-----BEGIN CERTIFICATE-----\n'
    ...
    /**
     * Amazon RDS eu-south-1 CA 2019 to 2024
     *
     *   CN = Amazon RDS eu-south-1 CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-10-30T19:21:30Z/2024-10-30T19:21:30Z
     *   F = C9:4E:30:62:38:FF:C4:96:E6:86:F6:CC:0F:BA:C2:29:62:BB:77:A2
     */
    '-----BEGIN CERTIFICATE-----\n'
    + 'MIIECTCCAvGgAwIBAgICEAAwDQYJKoZIhvcNAQELBQAwgZUxCzAJBgNVBAYTAlVT\n'
    + 'MRAwDgYDVQQHDAdTZWF0dGxlMRMwEQYDVQQIDApXYXNoaW5ndG9uMSIwIAYDVQQK\n'
    ...
    /**
     * Amazon RDS af-south-1 Root CA 2019 to 2024
     *
     *   CN = Amazon RDS af-south-1 Root CA
     *   OU = Amazon RDS
     *   O = Amazon Web Services, Inc.
     *   L = Seattle
     *   ST = Washington
     *   C = US
     *   P = 2019-10-28T17:05:58Z/2024-10-26T18:05:58Z
     *   F = FD:6F:9B:67:B4:78:61:76:FA:93:55:CB:C1:DB:81:CC:72:DE:CC:EB
     */
    '-----BEGIN CERTIFICATE-----\n'
