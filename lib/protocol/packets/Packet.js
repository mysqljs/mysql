...
Packet.prototype.write = function(buffer) {
  ...
  var complete = (this._elements.length === 0);

  // Not sure yet if I want to keep this, could be too strict.
  if (complete && (this.length.value + 4 != this.bytesWritten)) {
    throw new Error('Packet.IncompletePacket: ' + Util.inspect(this));
  }
