...
HandshakeInitializationPacket.prototype.hasCapabilityFlag = function hasCapabilityFlag(flag) {
  var serverCapabilities = this.serverCapabilities1;

  if (this.protocol41) {
    serverCapabilities |= this.serverCapabilities2 << 16;
  }
