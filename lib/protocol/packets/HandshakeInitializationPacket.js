...
function HandshakeInitializationPacket(properties) {
  ...
  this.push([
    ...
    this.scrambleBuff1       = new Elements.FixedSizeString(8, null, properties.scrambleBuff1),
    this.filler1             = new Elements.Filler(1, 0x00),
    ...
    this.filler2             = new Elements.Filler(10, 0x00),
...
HandshakeInitializationPacket.prototype.scrambleBuff = function() {
  return new BufferList([
    this.scrambleBuff1.value,
    this.scrambleBuff2.value
  ]).toBuffer();
};
