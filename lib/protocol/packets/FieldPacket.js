...
function FieldPacket(properties) {
  ...
  this.push([
    ...
    this.decimals    = new Elements.UnsignedNumber(1, properties.decimals),
    this.filler2     = new Elements.Filler(2, 0x00),

    // @TODO Re-enable this once Packet class can handle optional elements
    // like this.
    //this.default     = new Elements.LengthCodedString(null, properties.default),
  ]);
}
