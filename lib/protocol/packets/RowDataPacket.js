...
RowDataPacket.prototype.parse = function(parser, fieldPackets, typeCast, nestTables, utc) {
  for (var i = 0; i < fieldPackets.length; i++) {
    ...
    var value = (typeCast)
      ? this._typeCast(fieldPacket, parser, utc)
...
RowDataPacket.prototype._typeCast = function(field, parser, utc) {
  switch (field.type) {
    ...
    case Types.NEWDATE:
      ...
      // objects and strings as if they were in local time, unless the 'utc'
      // option is specified.
