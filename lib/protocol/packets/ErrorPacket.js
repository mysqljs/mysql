...
function ErrorPacket(properties) {
  ...
  this.push([
    ...
    this.sqlStateMarker = new Elements.FixedSizeString(1, 'utf-8', properties.sqlStateMarker),
    this.sqlState       = new Elements.FixedSizeString(5, 'utf-8', properties.sqlState),
