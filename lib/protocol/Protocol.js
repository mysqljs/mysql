...
Protocol.prototype.prepare = function(options, cb) {
  return this._enqueue(new Sequences.Statement(options, this, cb));
};

Protocol.prototype.executeStatement = function(options, cb) {
  return this._enqueue(new Sequences.PreparedQuery(options, cb));
};
