...
Client.prototype.end = function(cb) {
  ...
  //If we are connected before we call end(), we can send COM_QUIT,
  //but if we aren't even connected, we can just close the socket and call the callback immediately
  if(this.connected) {
...
Client.prototype._shutdown = function(cb) {
  this.destroy();
  if(cb) {
    cb.call(this);
  }
