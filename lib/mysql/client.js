...
function Client(properties) {
  ...
  this.host = properties.host || 'localhost';
  this.port = properties.port || 3306;
  this.user = properties.user || null;
  this.password = properties.password || null;
  this.database = properties.database || '';

  this.typeCast = properties.typeCast || true;
  this.maxPacketSize = properties.maxPacketSize || 0x01000000;
  this.charsetNumber = properties.charsetNumber || 8;
  this.flags = properties.flags || Client.defaultFlags;
