    ...
    switch (state) {
      ...
      case Parser.FIELD_COUNT:
        ...
        if (c === 0x00) {
          ...
          advance(false, Parser.AFFECTED_ROWS)
          break;
        }
        break;
      ...
      case Parser.ERROR_SQL_STATE:
        ...
        if (packet.index == 4) {
          advance(false, Parser.ERROR_MESSAGE);
        }
        break;
      ...
      case Parser.SERVER_STATUS:
        if (packet.index < 2) {
          packet.serverStatus = (packet.serverStatus || 0) + Math.pow(256, packet.index) * c;
          break;
        }
