...
Pool.prototype.getConnectionCounts = function () {
  return {
    allConnectionsCount       : this._allConnections.length,
    idleConnectionsCount      : this._freeConnections.length,
    connectionQueueCount      : this._connectionQueue.length,
    acquiringConnectionsCount : this._acquiringConnections.length,
    busyConnectionsCount      : this._allConnections.length - this._freeConnections.length - this._acquiringConnections.length
  };
};
