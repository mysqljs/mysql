...
Connection.prototype.connect = function(cb) {
  if (!this._connectCalled) {
    ...
    this._socket.setTimeout(this.config.timeout);

    this._socket.pipe(this._protocol);
    this._protocol.pipe(this._socket);

    this._socket.on('error', this._handleNetworkError.bind(this));
    this._socket.on('timeout', this._handleTimeoutError.bind(this));
...
Connection.prototype._handleTimeoutError = function() {
  this._protocol.handleNetworkError(new Error('timeout'));
};
