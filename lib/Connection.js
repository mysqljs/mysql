...
//
Connection.prototype.where = function(where) {
  var dbc = this,
    result = '';
...
//
Connection.prototype.select = function(table, fields, where, callback) {
...
//
Connection.prototype.insert = function(table, row, callback) {
  var dbc = this;
...
//
Connection.prototype.update = function(table, row, callback) {
  var dbc = this;
  dbc.fields(table, function(err, fields) {
    if (!err) {
      var where = '',
...
//
Connection.prototype.upsert = function(table, row, callback) {
  var dbc = this;
  dbc.fields(table, function(err, fields) {
    if (!err) {
      var rowKeys = Object.keys(row),
...
//
Connection.prototype.delete = function(table, where, callback) {
  var where = this.where(where);
