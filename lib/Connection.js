...
Connection.prototype.queryValue = function(sql, values, callback) {
  this.queryRow(sql, values, function(err, res) {
...
Connection.prototype.count = function(table, where, callback) {
...
Connection.prototype.primary = function(table, callback) {
  this.queryRow('SHOW KEYS FROM ?? WHERE Key_name = "PRIMARY"', [table], function(err, res) {
    callback(err, res);
  });
}

Connection.prototype.foreign = function(table, callback) {
  this.query(
...
Connection.prototype.fields = function(table, callback) {
...
Connection.prototype.databases = function(mask, callback) {
...
Connection.prototype.tables = function(mask, callback) {
...
Connection.prototype.tableInfo = function(table, callback) {
